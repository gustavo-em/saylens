...
/// The class is deliberately not called `LesingoObjectDetector`: that is the
/// name of the Swift module, and Swift's C++ interop header would then resolve
/// `LesingoObjectDetector::_impl` to this class instead of the module
/// namespace, which does not compile.
public final class LesingoVisionDetector: HybridLesingoObjectDetectorSpec {
