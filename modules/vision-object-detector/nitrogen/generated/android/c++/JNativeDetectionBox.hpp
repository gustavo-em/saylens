...
namespace margelo::nitro::spellformeobjectdetector {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NativeDetectionBox" and the Kotlin data class "NativeDetectionBox".
   */
  struct JNativeDetectionBox final: public jni::JavaClass<JNativeDetectionBox> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/spellformeobjectdetector/NativeDetectionBox;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NativeDetectionBox by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NativeDetectionBox toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNativeDetectionBox::javaobject> fromCpp(const NativeDetectionBox& value) {
      using JSignature = JNativeDetectionBox(double, double, double, double);
      static const auto clazz = javaClassStatic();
